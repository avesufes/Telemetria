...
#define DOUT  10                      // HX711 DATA OUT = pino A0 do Arduino 
#define CLK  11                       // HX711 SCK IN = pino A1 do Arduino 
 
HX711 balanca;          // define instancia balança HX711
 
float calibration_factor = 103000;     // fator de calibração para teste inicial
